...
type Emoji =
    ...
    member this.Props =
        let char, code, hint =
            ...
            | Construction -> "🚧", "construction", "Work in progress (wip), not yet finalized."
            | ConstructionWorker -> "👷", "construction_worker", "Add or update CI build system."
            | Dizzy -> "💫", "dizzy", "Add or update animations and transitions. #UI"
            | Egg -> "🥚", "egg", "Add or update an easter egg."
            | Fire -> "🔥", "fire", "(a.k.a flame) Remove code or files."
            ...
            | Iphone -> "📱", "iphone", "(a.k.a mobile_phone) Work on responsive design. #UI"
            | Label -> "🏷️", "label", "Add or update types."
            | Lipstick -> "💄", "lipstick", "Change the UI visually but not it's behaviour. #style"
            ...
            | RotatingLight -> "🚨", "rotating_light", "(a.k.a police_car_light) Fix compiler / linter warnings."
            | SafetyVest -> "🦺", "safety_vest", "Add or update code related to validation."
            | Seedling -> "🌱", "seedling", "Add or update seed files."
            | SeeNoEvil -> "🙈", "see_no_evil", "(a.k.a see_no_evil_monkey) Add or update a .gitignore file."
            ...
            | Tada -> "🎉", "tada", "(a.k.a party_popper) Begin a project."
